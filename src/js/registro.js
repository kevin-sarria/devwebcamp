...
(function () {
    ...
    if (resumen) {
        ...
        const formularioRegistros = document.querySelector('#registro');
        formularioRegistros.addEventListener('submit', submitFormulario);

        mostrarEventos();

        function seleccionarEvento({ target }) {

            // Validar que no se agregen mas de 6 elementos
            if (eventos.length >= 5) {
                Swal.fire({
                    title: 'Error',
